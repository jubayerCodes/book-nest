                ...
                <div className="book-details-container my-container grid grid-cols-10 gap-8">
                    <div className="book-details-left grid grid-cols-4 gap-8 col-span-8">
                        <div className="book-cover-container">
                            ...
                            <div className='mt-4'>
                                <Link href={'#'} className='preview-btn inline-flex gap-1 items-center hover:underline text-sm font-[var(--font-primary)]'>
                                    <FaRegEye /> Preview Now
                                </Link>
                        ...
                        <div className="book-info-container col-span-3">
                            ...
                            <div className="summary">
                                <h5 className='text-base font-medium mb-2 text-[var(--heading-color)]'>Summary</h5>
                                <p>
                            ...
                            <div className="about">
                                <h5 className='text-base font-medium mb-4 text-[var(--heading-color)'>About</h5>
